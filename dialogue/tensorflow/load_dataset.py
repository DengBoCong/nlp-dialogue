...
def load_data(dict_path: str, train_data_path: str, buffer_size: int, batch_size: int, data_type: str,
              max_sentence: int, valid_data_split: float = 0.0, valid_data_path: str = "",
    ...
    train_first, train_second, train_third = _read_data(
        ...
        max_sentence=max_sentence, data_type=data_type, tokenizer=tokenizer, **kwargs
    )
...
def _read_data(data_path: str, max_data_size: int, max_sentence: int, data_type: str,
    ...
    operation = {
        ...
        "read_smn_train_data": lambda: _read_smn_train_data(
...
def _read_smn_train_data(data_path: str, max_data_size: int, max_utterance: int, max_sentence: int,
                         tokenizer: tf.keras.preprocessing.text.Tokenizer) -> tuple:
